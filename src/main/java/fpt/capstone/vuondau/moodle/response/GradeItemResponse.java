...
public class GradeItemResponse {
    ...
    public void setScaleid(Object scaleid) {
    ...
    public int getGradedatesubmitted() {
        return gradedatesubmitted;
    }

    public void setGradedatesubmitted(int gradedatesubmitted) {
        this.gradedatesubmitted = gradedatesubmitted;
    }

    public int getGradedategraded() {
        return gradedategraded;
    }

    public void setGradedategraded(int gradedategraded) {
        this.gradedategraded = gradedategraded;
    }

    public boolean isGradehiddenbydate() {
    ...
    public boolean isGradeneedsupdate() {
    ...
    public boolean isGradeishidden() {
    ...
    public boolean isGradeislocked() {
    ...
    public boolean isGradeisoverridden() {
